...
<div class="main-content">
    ...
    <p class="text-muted mb-4">
        Gestiona la información que verán las empresas en tus postulaciones.
    </p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input
                                type="text"
                                class="form-control"
                                value="<?php echo $estudiante['nivel_curricular']; ?>"
                                readonly>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input
                                type="text"
                                class="form-control"
                                value="<?php echo $estudiante['ramos_aprobados']; ?>"
                                readonly>
                    ...
                    <form method="POST">
                        <div class="mb-3">
                            ...
                            <textarea   
                                name="habilidades"
                                class="form-control"
                                rows="5"><?php echo $estudiante['habilidades']; ?></textarea>
                        </div>
            ...
            <div class="card-body">
                ...
                <div class="text-center py-4">
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <?php if(!empty($cv['cv_estudiante'])){ ?>
        
                            <div class="mb-3">
        
                                <a
                                    href="../../archivos/cv/<?php echo $cv['cv_estudiante']; ?>"
                                    target="_blank"
                        ...
                        <button
                            ...
                            <?php echo !empty($cv['cv_estudiante']) ? 'Reemplazar CV' : 'Subir CV'; ?>
