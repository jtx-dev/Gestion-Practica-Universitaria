...
$consulta = mysqli_query($conexion, "SELECT u.id_usuario, u.correo, u.estado_cuenta, u.rut, i.nombre AS institucion, a.nombre AS nombre_admin, a.apellido, u.id_institucion
FROM usuario u
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (modalEditar) {
            modalEditar.addEventListener('show.bs.modal', function (event) {
                ...
                document.getElementById('editar_id_institucion').value = boton.getAttribute('data-institucion') || '0';
            });
        }
    });
</script>
